...
<div class="container">
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('harvest_season') is-invalid @enderror" id="harvest_season" name="harvest_season" value="{{ old('harvest_season') }}">
        ...
        <!-- Vùng Miền -->
        <div class="mb-3">
            <label for="region" class="form-label">Ở</label>
